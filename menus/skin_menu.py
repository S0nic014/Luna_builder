...
class SkinMenu(QtWidgets.QMenu):
    ...
    def create_connections(self):
        ...
        self.export_all_action.triggered.connect(lambda: importexport.SkinManager().export_all())
        self.import_all_action.triggered.connect(lambda: importexport.SkinManager().import_all())
        self.export_selected_action.triggered.connect(lambda: importexport.SkinManager.export_selected())
        self.import_selected_action.triggered.connect(lambda: importexport.SkinManager.import_selected())
        # Ng layers
        self.ngtools_export_all_action.triggered.connect(lambda: importexport.NgLayersManager().export_all())
